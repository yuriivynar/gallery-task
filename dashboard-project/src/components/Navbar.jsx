  ...
  return (
    <nav className="bg-blue-600 shadow-md p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-4">
        ...
        {user ? (
          <>
            <Link to="/dashboard" className="p-2 rounded hover:bg-blue-500 text-white">
              Головна
            </Link>
            <button
          ...
          <>
            <Link to="/login" className="p-2 rounded hover:bg-blue-500 text-white">
              Вхід
            </Link>
            <Link to="/register" className="p-2 rounded hover:bg-blue-500 text-white">
              Реєстрація
            </Link>
          </>
        )}
